...
app.register_blueprint(flags, url_prefix='/challenges')
app.register_blueprint(hints, url_prefix='/challenges')
app.register_blueprint(used_hints, url_prefix='/challenges')
